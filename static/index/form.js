document.addEventListener("DOMContentLoaded", () => {
    ...
    // Add-Cooperators Modal Logic
    document.querySelectorAll(".add-cooperators").forEach((ele) => {
        ele.addEventListener("click", () => {
            document.querySelector("#add-cooperators").style.display = "block";
        });
        document.querySelector("#close-add-cooperators").addEventListener("click", () => {
            document.querySelector("#add-cooperators").style.display = "none";
        });
        // Independent window click for Add-Cooperators
        window.addEventListener("click", (e) => {
            if (e.target == document.querySelector("#add-cooperators")) {
                document.querySelector("#add-cooperators").style.display = "none";
            }
        });
    });
    ...
    document.querySelector("#add-cooperators-form").addEventListener("submit", e => {
        e.preventDefault();
        const csrf = Cookies.get("csrftoken");
        const emails = document.querySelector("#cooperators-emails").value.trim();
        const message = document.querySelector("#cooperators-message").value.trim();
    
        fetch('add_cooperators/', {
            method: "POST",
            headers: { 'X-CSRFToken': csrf },
            body: JSON.stringify({
