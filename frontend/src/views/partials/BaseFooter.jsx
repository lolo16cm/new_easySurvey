        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                Easy Survey simplifies your life by allowing you to quickly create user-friendly surveys and view results in real time. You can also complete surveys you receive and review your responses with ease.
                </p>
                {/* social media */}
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p>Binghamton, U.S.A</p>
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> djangoatbing@gmail.com</a>
              </p>
            </div>
          </div>
        </div>
